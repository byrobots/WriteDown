<template>
    <section id="post-form-container">
        ...
        >
            ...
            <div id="post-publish-at-row" class="form-row">
                <label for="post-publish-at">Publish at</label>
                <span v-if="null !== errors.publishAt" class="single-error">
                    <i class="fas fa-exclamation" />
                    {{ errors.publishAt }}
                </span>
            ...
            <div id="post-excerpt-row" class="form-row">
                ...
                <span v-if="null !== errors.excerpt" class="single-error">
                    <i class="fas fa-exclamation" />
                    {{ errors.excerpt }}
                </span>

                <input id="post-excerpt" v-model="post.excerpt" type="text" name="post-excerpt">
            </div>

            <div class="form-row">
                <label for="post-body">Body</label>
                <span v-if="null !== errors.body" class="single-error">
                    <i class="fas fa-exclamation" />
                    {{ errors.body }}
                </span>

                <textarea id="post-body" v-model="post.body" name="post-body" class="wysiwyg-editor"/>
            </div>

            <div class="form-row">
                <button class="submit-button" @click="attemptStore">
                    <i class="fas fa-save" />
                    Save
                </button>
            </div>
